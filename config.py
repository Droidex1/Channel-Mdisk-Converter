...
API_ID = int(os.environ.get("API_ID", "14020488"))
API_HASH = os.environ.get("API_HASH", "8fa7b8a767415c150b9a9ed56d7358ce")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6065917556:AAFKrQHQuxtaxBXGRc4ao-yy5WSeDCn_xDQ")
DROPLINK_API = os.environ.get("DROPLINK_API")
MDISK_API = os.environ.get("MDISK_API", "6p0ibxdPNh6JqMmCXM4H")
ADMINS = list(int(i.strip()) for i in os.environ.get("ADMINS").split("5103557143")) if os.environ.get("ADMINS") else []
DATABASE_NAME = os.environ.get("DATABASE_NAME", "MdiskConvertorBotpro")
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Onemanhost:8122949387@cluster0.m1wmxne.mongodb.net/?retryWrites=true&w=majority")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001641941174")) if os.environ.get("CHANNEL_ID") else []
...
USERNAME = os.environ.get("USERNAME", "onemanhost")
